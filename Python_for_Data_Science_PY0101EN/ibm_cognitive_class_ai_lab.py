...
# Type of objects in Python. Python is an interpretted object-oriented language 
...
# if we have a string that contains a number within it. we can cast that string into an interger
print(int('1'))
